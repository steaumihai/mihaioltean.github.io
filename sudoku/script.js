document.getElementById("v1").innerHTML = "v2.38";
...
// corners
					...
					for (var row = 0; row < max_row_scaled; row++)
						for (var col = 0; col < max_col_scaled; col++){
							...
							digit_as_28x28_matrix[(row + 4 + (max_row_scaled - 20) / 2) * 28 + col + 4 + (max_col_scaled - 20) / 2] = rgb_to_gray(pixel_data.data) / 255.0;
							imageData.data[(row + 4 + (max_row_scaled - 20) / 2) * 28 * 4 + (col + 4 + (max_col_scaled - 20) / 2) * 4] = digit_as_28x28_matrix[(row + 4 + (max_row_scaled - 20) / 2) * 28 + col + 4 + (max_col_scaled - 20) / 2] * 255;
							imageData.data[(row + 4 + (max_row_scaled - 20) / 2) * 28 * 4 + (col + 4 + (max_col_scaled - 20) / 2) * 4 + 1] = digit_as_28x28_matrix[(row + 4 + (max_row_scaled - 20) / 2) * 28 + col + 4 + (max_col_scaled - 20) / 2] * 255;
							imageData.data[(row + 4 + (max_row_scaled - 20) / 2) * 28 * 4 + (col + 4 + (max_col_scaled - 20) / 2) * 4 + 2] = digit_as_28x28_matrix[(row + 4 + (max_row_scaled - 20) / 2) * 28 + col + 4 + (max_col_scaled - 20) / 2] * 255;
							imageData.data[(row + 4 + (max_row_scaled - 20) / 2) * 28 * 4 + (col + 4 + (max_col_scaled - 20) / 2) * 4 + 3] = 255;
						}
